...
class TestRoutes:
    ...
    def test_alarms_success(self, client, sample_trades):
        ...
        violations = [a for a in data['alarms'] if a['account_id'] == 'ACC003' and a['ticker'] == 'NVDA']
